...
`<div class="col-sm-10"><input type="text" id="fnNameInput_${uid}" class="form-control" `,
`pattern="[A-Za-z0-9_&#92;.&#92;-()]+" placeholder="Enter a short identifier for this image..." required/>`,
...
`<input type="number" class="form-control" id="heightInput_${uid}" min="5" max="380" placeholder="Enter a height range `,
